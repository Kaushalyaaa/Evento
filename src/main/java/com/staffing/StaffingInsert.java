...
@WebServlet("/StaffingInsert")
public class StaffingInsert extends HttpServlet {
   ...
   ///Check if any required field is empty
		...
		isTrue = StaffingDBUtil.insertStaff (eventName,customerReq,photographer,catering,decoration,security,technical,salaryRange,additionalEmployees,extraNotes,username,password);
				if(isTrue==true) {
					...
					List<Staffing> staffdetails = StaffingDBUtil.getstaffdetails(username);
					request.setAttribute("staffdetails", staffdetails);
					RequestDispatcher dis2 = request.getRequestDispatcher("staffing.jsp");
